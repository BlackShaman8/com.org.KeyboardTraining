...
<form>
  ...
  <div >
		...
		<a class="c-button" style= "left: 20px;width:100px" href="/user/training" >Повторить</a>
		<a class="c-button" style= "left: 30px;height:40px;width:100px" href="/user/trainingParameters" >Далее</a>
  </fieldset>
</form>
