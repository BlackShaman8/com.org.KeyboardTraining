...
<div id="templatemo_body_wrapper">
    <div id="templatemo_wrapper">
        ...
        <div id="templatemo_header">
            ...
            <div id="site_title"><h3 style="color:#008080"><b>Руководство пользователя</b></h3></div>
            ...
            <div>
                <div>
                    <h4 style="color:#c68a4a;">
                        <br>
                        После авторизации происходит переход на главную страницу пользователя, представленную на рисунке
                        1. На
                    ...
                    <h4 style="color:#c68a4a;">
                        ...
                        <br> При нажатии на кнопку «Редактировать учетную запись» появляется страница, представленная на
                        рисунке 2.
                    ...
                    <h4 style="color:#c68a4a;">
                        ...
                        <br>На странице расположены кнопки «Общая статистика», «Тренировка», «Главная страница»,
                        «Наверх», а также
                    ...
                    <h4 style="color:#c68a4a;">
                        ...
                        <br>При нажатии на кнопку «Общая статистика» происходит переход на страницу, представленную на
                        рисунке 4,
                    ...
                    <h4 style="color:#c68a4a;">
                        ...
                        <br> При нажатии на кнопку «Тренировка», расположенной на главной странице, происходит переход
                        на
